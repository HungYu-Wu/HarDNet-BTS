    ...
    def __init__(self, inplanes, planes, norm_layer=None, dilation=1, dropout=0):
        if norm_layer is not None:
            super(ConvBnRelu, self).__init__(
                OrderedDict(
                    [
                        ('conv', conv3x3(inplanes, planes,stride=2, dilation=dilation)),
    ...
    def __init__(self, inplanes, planes, norm_layer=None, dilation=1, dropout=0):
        if norm_layer is not None:
            super(ConvBnRelu1, self).__init__(
                OrderedDict(
                    [
                        ('conv', conv3x3(inplanes, planes,stride=1, dilation=dilation)),
                        ('bn', norm_layer(planes)),
                        ('relu', nn.LeakyReLU(inplace=True)),
                        ('dropout', nn.Dropout(p=dropout)),
                    ]
        ...
        super(UBlock, self).__init__(
            OrderedDict(
                [
                    ...
                    (
                        'ConvBnRelu2',
                        ConvBnRelu1(midplanes, outplanes, norm_layer, dilation=dilation[1], dropout=dropout)),
                ])
        )
...
class UBlock1(nn.Sequential):
    ...
    def __init__(self, inplanes, midplanes, outplanes, norm_layer, dilation=(1, 1), dropout=0):
        super(UBlock1, self).__init__(
            OrderedDict(
                [
                    ('ConvBnRelu1', ConvBnRelu1(inplanes, midplanes, norm_layer, dilation=dilation[0], dropout=dropout)),
                    (
                        'ConvBnRelu2',
                        ConvBnRelu1(midplanes, outplanes, norm_layer, dilation=dilation[1], dropout=dropout)),
                ])
